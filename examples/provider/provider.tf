...
provider "gamefabric" {
  # The GameFabric API host (optional, when customer_id is provided)
  ...
  # The customer ID for your GameFabric installation (optional, when host is provided)
  # If not provided, the host must be specified
...
#   # export GAMEFABRIC_HOST="your-host"
# }
