...
- `GAMEFABRIC_ENFORCE_AUTH_METHOD`: Force a specific authentication method. Valid values are `serviceaccount` or `browser`. If not set, the provider will automatically choose the authentication method based on the provided configuration.
