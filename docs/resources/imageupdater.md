...
The image updater is a resource that allows you to automatically update the container image used by a target resource (like an Armada, Formation, Vessel, or ArmadaSet) whenever a new image tag is pushed to specified image in the GameFabric container registry.
